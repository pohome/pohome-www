<?PHP
    class message{
        ...
        protected function getTimestamp(){
            $api='http://api.submail.cn/service/timestamp.json';
            $ch = curl_init($api) ;
        ...
        public function send($request){
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $api='http://api.submail.cn/message/send.json';
        ...
        public function xsend($request){
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $api='http://api.submail.cn/message/xsend.json';
        ...
        public function subscribe($request){
            ...
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $api='http://api.submail.cn/addressbook/message/subscribe.json';
        ...
        public function unsubscribe($request){
            /*
             ...
             |--------------------------------------------------------------------------
             */
            $api='http://api.submail.cn/addressbook/message/unsubscribe.json';
