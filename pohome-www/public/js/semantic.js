      ...
      module = {
        ...
        set: {
          ...
          percent: function(percent) {
            ...
            if(module.total) {
              //module.value = Math.round( (percent / 100) * module.total); sieg
            }
